...
public abstract class StandOutWindow extends Service {
	...
	public int getOtherFlags(int id) {
		...
		return StandOutLayoutParams.FLAG_NOT_TOUCH_MODAL | StandOutLayoutParams.FLAG_WATCH_OUTSIDE_TOUCH | (prefs.getBoolean("hardwareAccel", true) ? StandOutLayoutParams.FLAG_HARDWARE_ACCELERATED : 0);
	}
